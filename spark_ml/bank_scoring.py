...
def prepare_data(df: DataFrame, assembler) -> DataFrame:
    ...
    married_index = StringIndexer(inputCol='married', outputCol="married_index")
...
def vector_assembler() -> VectorAssembler:
    features = ['age', 'salary', 'successfully_credit_completed', 'credit_completed_amount', 'active_credits', 'active_credits_amount', 'credit_amount', 'sex_index', 'married_index']
